                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div className="flex items-center lg:order-2">
                        <div className="hidden mt-2 mr-4 sm:inline-block">
                            <a className="github-button" href="https://github.com/themesberg/landwind" datasize="large" dataicon="octicon-star" datashowcount="true" aria-label="Star themesberg/landwind on GitHub">Star</a>
                        </div>
