                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <a  className="github-button" href="https://github.com/themesberg/landwind" data-size="large" data-icon="octicon-star" data-show-count="true" aria-label="Star themesberg/landwind on GitHub">Star</a>
                            {/* <a rel="noopener noreferrer" target='_blank' className="github-button" href="https://github.com/themesberg/landwind" datasize="large" dataicon="octicon-star" datashowcount="true" aria-label="Star themesberg/landwind on GitHub">Star</a> */}
                        </div>
                        ...
                        <button onClick={() => setMenu(!menu)} data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
                    ...
                    <div className={`${menu ? "" : "hidden"} items-center justify-between w-full lg:flex lg:w-auto lg:order-1`} id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            <li>
                                <div className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 lg:p-0 dark:text-gray-400">Company</div>
                            </li>
                            <li>
