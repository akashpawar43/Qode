        ...
        <>
            <section className="bg-white dark:bg-gray-900">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    {/* <!-- Pricing Card --> */}
                    <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-purple-100 border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    ...
                    {/* <!-- Pricing Card --> */}
                    <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-zinc-100 border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        ...
                        <a href="#" className="text-white bg-zinc-600 hover:bg-zinc-700 focus:ring-4 focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">Get started</a>
                    </div>
                    {/* <!-- Pricing Card --> */}
                    <div className="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-purple-100 border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
